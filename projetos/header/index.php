<php
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"
            integrity="sha384-J2uqaLdRtACQYWweY2niwLHP2MFxSVxICXntGOYBRw8By2PScNMpFm3CN7E+eBto" crossorigin="anonymous">
    ...
    <div class="header"><!-- • header • -->
        <div class="logo"><!-- • logo • -->
            <img id="logo" src="imgs/img01.jpg" alt="">
        </div><!-- X logo X -->
        ...
        <div class="logon"><!-- • logon • -->
            <a href="php/login/login.php" class="login-link" title="Login">
